from gainy.analytics.constants import PROPERTY_PROFILE_ID, PROPERTY_USER_EMAIL, PROPERTY_MATCH_SCORE_CREATED, \
    PROPERTY_DW_ACCOUNT_OPENED, PROPERTY_FUNDING_ACC_CONNECTED, PROPERTY_NUMBER_OF_FUNDING_ACC, \
    PROPERTY_BANK_FUNDING_ACC, PROPERTY_PRODUCT_TYPE_PURCHASED, PROPERTY_TOTAL_INVESTED_TTFS, \
    PROPERTY_TOTAL_INVESTED_TICKERS, PROPERTY_TOTAL_TRANSACTIONS, PROPERTY_TOTAL_DEPOSITS, PROPERTY_TOTAL_INVESTS, \
    PROPERTY_TOTAL_SELLS, PROPERTY_TOTAL_AMOUNT_DEPOSIT, PROPERTY_TOTAL_AMOUNT_INVEST, PROPERTY_TOTAL_AMOUNT_SELL, \
    PROPERTY_FIRST_PURCHASED_DATE, PROPERTY_FIRST_SELL_DATE, PROPERTY_LAST_PURCHASED_DATE, PROPERTY_LAST_SELL_DATE, \
    PROPERTY_USER_TYPE
...
class FirebaseService(AnalyticsSinkInterface):
    ...
    def update_user_properties(self, profile_id: int, properties: dict):
        ...
        try:
            ...
            logger.info(e.__class__.__name__, extra={"profile_id": profile_id})
            pass
